...
import { confirmSubscriber } from '@/lib/supabase/queries';

export const metadata: Metadata = {
  title: 'Confirm – AI Morning Digest',
};
...
export default async function ConfirmPage({
  ...
  let message = 'Invalid or missing confirmation link.';

  if (token) {
    const ok = await confirmSubscriber(token);
    message = ok
      ? "You're confirmed! You'll start receiving the digest tomorrow morning."
